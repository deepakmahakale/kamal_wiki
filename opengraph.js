...
async function handler() {
  ...
  let svgImage = `
        ...
        <rect x="30" y="30" width="1140" height="570" fill="#fffcf1" stroke="#FC8882" strokeWidth="2" />
        ${iconData}
        <text x="50%" text-anchor="middle" y="${iconTextPosition}"  class="heading">kamal.wiki</text>
